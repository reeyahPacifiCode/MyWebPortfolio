...
<head>
  ...
  <title>UrbanVista Ridge – Pasig City</title>
</head>
<body>
<!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Ridge – Pasig City</h1>
        <p><i class="bi bi-geo-alt-fill me-1"></i>86 Ortigas Ave., Pasig City, Metro Manila, Philippines</p>
      </div>
      ...
      <div class="position-relative d-flex justify-content-center align-items-center mt-0 mb-3">
        ...
        <div class="image-frame">
          <!-- Main Image -->
        <img id="mainImage" src="assets/building/bldg10.jpg" style="width: 400px; height:350px; object-fit: cover; cursor:pointer;" onclick="openModal(this.src)" />
        </div>
      ...
      <div class="d-flex justify-content-center gap-2 flex-wrap mb-3 mt-3" id="thumbnails">
        <img src="assets/building/bldg10.jpg" class="thumbnail-img active" onclick="changeImage(this)" />
        <img src="assets/Unit/unit10.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit10a.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit10b.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit10c.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitieso.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesp.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Location/location 10.png" class="thumbnail-img" onclick="changeImage(this)" />
      </div>
    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">UrbanVista Ridge – Pasig City</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                 Nestled along the scenic Ortigas Avenue, <strong>UrbanVista Ridge</strong> at 86 Ortigas Ave. offers 
                a modern residential space that is perfect for families and professionals alike. With convenient access to 
                business hubs, schools, and shopping malls, this development offers a well-rounded living experience.
              </p>
              <hr class="my-4" />
              <!-- Amenities -->
              <h6 class="fw-semibold mb-3">Amenities</h6>
              <div class="row gy-2">
                <div class="col-6"><i class="bi bi-house-door me-2"></i>Children's park and play area</div>
                <div class="col-6"><i class="bi bi-gym me-2"></i>State-of-the-art gym</div>
                <div class="col-6"><i class="bi bi-camera-video me-2"></i>24/7 CCTV security</div>
                <div class="col-6"><i class="bi bi-wifi me-2"></i>High-speed internet access</div>
                <div class="col-6"><i class="bi bi-lock me-2"></i>Secure parking facilities</div>
                <div class="col-6"><i class="bi bi-tree me-2"></i>Landscaped outdoor spaces</div>
              </div>
              <!-- Nearby Locations -->
              <h6 class="fw-semibold mt-4 mb-3">Nearby Landmarks</h6>
              <div class="row gy-2">
                <div class="col-12"><i class="bi bi-shop me-2"></i>SM Megamall – 8 mins</div>
                <div class="col-12"><i class="bi bi-hospital me-2"></i>St. Luke’s Medical Center – 12 mins</div>
                <div class="col-12"><i class="bi bi-train-front me-2"></i>Shaw Blvd MRT Station – 10 mins</div>
                <div class="col-12"><i class="bi bi-bag me-2"></i>SM Aura Premier – 15 mins</div>
                <div class="col-12"><i class="bi bi-building me-2"></i>Ortigas Center Business District – 5 mins</div>
              </div>
              <!-- Location -->
              <h6 class="fw-semibold mt-4 mb-2">Location</h6>
              <p class="text-justify mb-0">
                <strong>UrbanVista Ridge – Pasig City</strong><br />
                86 Ortigas Ave., Pasig City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Ridge – Pasig City" />
            </div>
          </div>
        </div>
    </div>
