...
<head>
  ...
  <title>UrbanVista Skyline – Mandaluyong</title>
</head>
<body>
 <!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Skyline – Mandaluyong</h1>
        <p><i class="bi bi-geo-alt-fill me-1"></i>1342 EDSA cor. Shaw Blvd., Mandaluyong City, Metro Manila, Philippines</p>
      </div>
      ...
      <div class="position-relative d-flex justify-content-center align-items-center mt-0 mb-3">
        ...
        <div class="image-frame">
          <!-- Main Image -->
        <img id="mainImage" src="assets/building/bldg7.jpg" style="width: 400px; height:350px; object-fit: cover; cursor:pointer;" onclick="openModal(this.src)" />
        </div>
      ...
      <div class="d-flex justify-content-center gap-2 flex-wrap mb-3 mt-3" id="thumbnails">
        <img src="assets/building/bldg7.jpg" class="thumbnail-img active" onclick="changeImage(this)" />
        <img src="assets/Unit/unit7.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit7a.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit7b.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit7d.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesj.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesv.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Location/location7.png" class="thumbnail-img" onclick="changeImage(this)" />
      </div>
    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">UrbanVista Skyline – Mandaluyong</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                Strategically located at the corner of EDSA and Shaw Blvd., <strong>UrbanVista Skyline – Mandaluyong</strong> 
                offers a prime residential address with unparalleled access to commercial centers, entertainment hubs, 
                and public transport. Whether you’re commuting to work or exploring the vibrant city life, this modern development 
                offers all the convenience and comfort of urban living.
              </p>
              <hr class="my-4" />
              <!-- Amenities -->
              <h6 class="fw-semibold mb-3">Amenities</h6>
              <div class="row gy-2">
                <div class="col-6"><i class="bi bi-house-door me-2"></i>Spacious basement parking</div>
                <div class="col-6"><i class="bi bi-droplet me-2"></i>Infinity rooftop pool</div>
                <div class="col-6"><i class="bi bi-camera-video me-2"></i>24/7 CCTV security</div>
                <div class="col-6"><i class="bi bi-wifi me-2"></i>High-speed fiber optic internet</div>
                <div class="col-6"><i class="bi bi-building me-2"></i>Secured lobby with concierge service</div>
                <div class="col-6"><i class="bi bi-sunrise me-2"></i>Scenic outdoor deck</div>
              </div>
              <!-- Nearby Locations -->
              <h6 class="fw-semibold mt-4 mb-3">Nearby Landmarks</h6>
              <div class="row gy-2">
                 <div class="col-12"><i class="bi bi-briefcase me-2"></i>Ortigas Business District – 5 mins</div>
                <div class="col-12"><i class="bi bi-shop me-2"></i>SM Megamall – 4 mins</div>
                <div class="col-12"><i class="bi bi-train-front me-2"></i>MRT Shaw Blvd. Station – 2 mins</div>
                <div class="col-12"><i class="bi bi-hospital me-2"></i>St. Luke's Medical Center – 8 mins</div>
                <div class="col-12"><i class="bi bi-cup-hot me-2"></i>Kapitolyo Food Strip – 7 mins</div>
              </div>
              <!-- Location -->
              <h6 class="fw-semibold mt-4 mb-2">Location</h6>
              <p class="text-justify mb-0">
                <strong>UrbanVista Skyline – Mandaluyong</strong><br />
                1342 EDSA cor. Shaw Blvd., Mandaluyong City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Skyline – Mandaluyong" />
            </div>
          </div>
        </div>
    </div>
