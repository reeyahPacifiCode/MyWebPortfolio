...
<head>
  ...
  <title>UrbanVista Green – Katipunan</title>
</head>
<body>
<!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Green – Katipunan</h1>
        <p><i class="bi bi-geo-alt-fill me-1"></i>Katipunan Ave., Loyola Heights, Quezon City, Metro Manila, Philippines</p>
      </div>
      ...
      <div class="position-relative d-flex justify-content-center align-items-center mt-0 mb-3">
        ...
        <div class="image-frame">
          <!-- Main Image -->
        <img id="mainImage" src="assets/building/bldg4.jpg" style="width: 400px; height:350px; object-fit: cover; cursor:pointer;" onclick="openModal(this.src)" />
        </div>
      ...
      <div class="d-flex justify-content-center gap-2 flex-wrap mb-3 mt-3" id="thumbnails">
        <img src="assets/building/bldg4.jpg" class="thumbnail-img active" onclick="changeImage(this)" />
        <img src="assets/Unit/unit4.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit4a.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesc.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesd.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiese.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiess.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Location/location4.png" class="thumbnail-img" onclick="changeImage(this)" />
      </div>
    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">>UrbanVista Green – Katipunan</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                Perfectly positioned in the academic and residential heart of Quezon City, <strong>UrbanVista Green – Katipunan</strong> 
                brings together comfort, sustainability, and accessibility. Located along Katipunan Avenue in Loyola Heights, 
                this eco-friendly residence offers direct access to renowned universities, vibrant cafes, and green spaces—
                an ideal home for students, professionals, and families seeking balance.
              </p>
              <hr class="my-4" />
              <!-- Amenities -->
              <h6 class="fw-semibold mb-3">Amenities</h6>
              <div class="row gy-2">
                <div class="col-6"><i class="bi bi-bicycle me-2"></i>Secure bicycle parking area</div>
                <div class="col-6"><i class="bi bi-person-video3 me-2"></i>Business center & co-working zone</div>
                <div class="col-6"><i class="bi bi-house-door me-2"></i>Spacious visitor lounge</div>
                <div class="col-6"><i class="bi bi-camera-video me-2"></i>24/7 CCTV & security</div>
                <div class="col-6"><i class="bi bi-wifi me-2"></i>Fiber internet connectivity</div>
                <div class="col-6"><i class="bi bi-sunrise me-2"></i>Community garden & open green areas</div>
              </div>
              <!-- Nearby Locations -->
              <h6 class="fw-semibold mt-4 mb-3">Nearby Landmarks</h6>
              <div class="row gy-2">
                <div class="col-12"><i class="bi bi-mortarboard me-2"></i>Ateneo de Manila University – 2 mins</div>
                <div class="col-12"><i class="bi bi-journal-bookmark me-2"></i>Miriam College – 4 mins</div>
                <div class="col-12"><i class="bi bi-mortarboard me-2"></i>UP Diliman – 10 mins</div>
                <div class="col-12"><i class="bi bi-train-front me-2"></i>LRT Katipunan Station – 3 mins</div>
                <div class="col-12"><i class="bi bi-cup-hot me-2"></i>Maginhawa Food Hub – 7 mins</div>
              </div>
              <!-- Location -->
              <h6 class="fw-semibold mt-4 mb-2">Location</h6>
              <p class="text-justify mb-0">
                <strong>UrbanVista Green – Katipunan</strong><br />
                Katipunan Ave., Loyola Heights, Quezon City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Green – Katipunan" />
            </div>
          </div>
        </div>
    </div>
