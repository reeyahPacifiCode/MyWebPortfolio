...
<head>
  ...
  <title>Urban Vista Tower 1</title>
</head>
<body>
<!-- Fixed Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow">
  <div class="container-fluid">
    <a class="navbar-brand text-logo" href="index.php#top">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="position-relative d-flex justify-content-center align-items-center mt-0 mb-3">
        ...
        <div class="image-frame">
          <!-- Main Image -->
        <img id="mainImage" src="assets/bldg1.jpg" style="width: 400px; height:350px; object-fit: cover; cursor:pointer;" onclick="openModal(this.src)" />
        </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">Urban Vista Tower 1 - Aurora Boulevard</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                Situated in the vibrant center of the city, <strong>Urban Vista Tower 1 - Aurora Boulevard</strong> is a modern 
              ...
              <p class="text-justify mb-0">
                <strong>Urban Vista Tower 1</strong><br />
                Aurora Boulevard, Quezon City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="Urban Vista Tower 1" />
            </div>
          </div>
        </div>
    </div>
