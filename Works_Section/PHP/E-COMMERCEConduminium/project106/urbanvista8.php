...
<head>
  ...
  <title>UrbanVista Parklane – Quezon City</title>
</head>
<body>
<!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Parklane – Quezon City</h1>
        <p><i class="bi bi-geo-alt-fill me-1"></i> 19 Commonwealth Ave., Quezon City, Metro Manila, Philippines</p>
      </div>
      ...
      <div class="position-relative d-flex justify-content-center align-items-center mt-0 mb-3">
        ...
        <div class="image-frame">
          <!-- Main Image -->
        <img id="mainImage" src="assets/building/bldg8.jpg" style="width: 400px; height:350px; object-fit: cover; cursor:pointer;" onclick="openModal(this.src)" />
        </div>
      ...
      <div class="d-flex justify-content-center gap-2 flex-wrap mb-3 mt-3" id="thumbnails">
        <img src="assets/building/bldg8.jpg" class="thumbnail-img active" onclick="changeImage(this)" />
        <img src="assets/Unit/unit8.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit8a.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit8b.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit8c.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesk.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesl.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Location/location8.png" class="thumbnail-img" onclick="changeImage(this)" />
      </div>
    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">UrbanVista Parklane – Quezon City</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                Situated in the lush green surroundings of Quezon City, <strong>UrbanVista Parklane</strong> 
                at 19 Commonwealth Ave. offers a blend of tranquil living with access to the city’s best retail, 
                educational, and recreational destinations. Experience the luxury of having your own parkland while being 
              ...
              <div class="row gy-2">
                <div class="col-6"><i class="bi bi-house-door me-2"></i>24/7 Front Desk Service</div>
                <div class="col-6"><i class="bi bi-thermometer-sun me-2"></i>Relaxing sauna</div>
                ...
                <div class="col-6"><i class="bi bi-tree me-2"></i>Landscaped garden and park</div>
                <div class="col-6"><i class="bi bi-box-arrow-in-right me-2"></i>Secure parking facilities</div>
              </div>
              <!-- Nearby Locations -->
              <h6 class="fw-semibold mt-4 mb-3">Nearby Landmarks</h6>
              <div class="row gy-2">
                <div class="col-12"><i class="bi bi-shop me-2"></i>SM City North EDSA – 10 mins</div>
                <div class="col-12"><i class="bi bi-hospital me-2"></i>Quezon City General Hospital – 7 mins</div>
                <div class="col-12"><i class="bi bi-train-front me-2"></i>North Avenue MRT Station – 12 mins</div>
                <div class="col-12"><i class="bi bi-bag me-2"></i>Trinoma Mall – 15 mins</div>
                <div class="col-12"><i class="bi bi-hospital me-2"></i>St. Luke's Medical Center – 10 mins</div>
              </div>
              <!-- Location -->
              <h6 class="fw-semibold mt-4 mb-2">Location</h6>
              <p class="text-justify mb-0">
                <strong>UrbanVista Parklane – Quezon City</strong><br />
                19 Commonwealth Ave., Quezon City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Parklane – Quezon City" />
            </div>
          </div>
        </div>
    </div>
