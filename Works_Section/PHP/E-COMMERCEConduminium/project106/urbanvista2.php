...
<head>
  ...
  <title>UrbanVista Residences – Bayview</title>
</head>
<body>
 <!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Residences – Bayview</h1>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">UrbanVista Residences – Bayview</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
               Nestled in the vibrant coastal district of Pasay City, <strong>UrbanVista Residences – Bayview</strong> offers 
                ...
                transport terminals—ideal for urban dwellers seeking convenience and coastal charm.
              </p>
              <hr class="my-4" />
              <!-- Amenities -->
              ...
              <p class="text-justify mb-0">
                <strong>UrbanVista Residences – Bayview</strong><br />
                21 Bayview St., Pasay City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Residences – Bayview" />
            </div>
          </div>
        </div>
    </div>
