...
<head>
  ...
  <title>UrbanVista Heights – Makati</title>
</head>
<body>
<!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Heights – Makati</h1>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">UrbanVista Heights – Makati</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                Located in the heart of the metro’s financial and lifestyle district, <strong>UrbanVista Heights – Makati</strong> 
                sits along the prestigious Jupiter Street. This upscale residential tower offers urban sophistication, 
              ...
              <p class="text-justify mb-0">
                <strong>UrbanVista Heights – Makati</strong><br />
                5 Jupiter St., Makati City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Heights – Makati" />
            </div>
          </div>
        </div>
    </div>
