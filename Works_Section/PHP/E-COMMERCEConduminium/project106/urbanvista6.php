...
<head>
  ...
  <title>UrbanVista Oasis – Parañaque</title>
</head>
<body>
<!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Oasis – Parañaque</h1>
        <p><i class="bi bi-geo-alt-fill me-1"></i>888 Aurora Blvd, Quezon City</p>
      </div>
      ...
      <div class="position-relative d-flex justify-content-center align-items-center mt-0 mb-3">
        ...
        <div class="image-frame">
          <!-- Main Image -->
        <img id="mainImage" src="assets/building/bldg6.webp" style="width: 400px; height:350px; object-fit: cover; cursor:pointer;" onclick="openModal(this.src)" />
        </div>
      ...
      <div class="d-flex justify-content-center gap-2 flex-wrap mb-3 mt-3" id="thumbnails">
        <img src="assets/building/bldg6.webp" class="thumbnail-img active" onclick="changeImage(this)" />
        <img src="assets/Unit/unit6.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit6a.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit6b.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit6c.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesi.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesu.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Location/location6.png" class="thumbnail-img" onclick="changeImage(this)" />
      </div>
    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">UrbanVista Oasis – Parañaque</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                Nestled in the vibrant southern district of Metro Manila, <strong>UrbanVista Oasis – Parañaque</strong> 
                offers a serene and well-connected living experience along Sucat Road. With direct access to the 
                airport, entertainment hubs, and business parks, this residence blends tropical charm with modern convenience.
              </p>
              <hr class="my-4" />
              <!-- Amenities -->
              <h6 class="fw-semibold mb-3">Amenities</h6>
              <div class="row gy-2">
                <div class="col-6"><i class="bi bi-sunset me-2"></i>Rooftop lounge with sunset views</div>
                <div class="col-6"><i class="bi bi-heart-pulse me-2"></i>Fully-equipped fitness gym</div>
                <div class="col-6"><i class="bi bi-camera-video me-2"></i>24/7 CCTV and building security</div>
                <div class="col-6"><i class="bi bi-wifi me-2"></i>Fiber internet-ready units</div>
                <div class="col-6"><i class="bi bi-house-heart me-2"></i>Community lounge</div>
                <div class="col-6"><i class="bi bi-tree me-2"></i>Landscaped open spaces</div>
              </div>
              <!-- Nearby Locations -->
              <h6 class="fw-semibold mt-4 mb-3">Nearby Landmarks</h6>
              <div class="row gy-2">
                <div class="col-12"><i class="bi bi-airplane me-2"></i>Ninoy Aquino International Airport – 10 mins</div>
                <div class="col-12"><i class="bi bi-shop me-2"></i>SM City Sucat – 5 mins</div>
                <div class="col-12"><i class="bi bi-hospital me-2"></i>Medical Center Parañaque – 7 mins</div>
                <div class="col-12"><i class="bi bi-geo-alt me-2"></i>Aseana City – 15 mins</div>
                <div class="col-12"><i class="bi bi-train-front me-2"></i>LRMC Dr. A. Santos Station – 6 mins</div>
              </div>
              <!-- Location -->
              <h6 class="fw-semibold mt-4 mb-2">Location</h6>
              <p class="text-justify mb-0">
                 <strong>UrbanVista Oasis – Parañaque</strong><br />
                12 Sucat Road, Parañaque City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Oasis – Parañaque" />
            </div>
          </div>
        </div>
    </div>
