...
<head>
  ...
  <title>UrbanVista Central – San Juan</title>
</head>
<body>
 <!-- Fixed Navbar -->
  ...
  <div class="row">
    ...
    <div class="col-lg-8 mb-4">
      ...
      <div class="heading1 mb-2 px-2">
        <h1>UrbanVista Central – San Juan</h1>
        <p><i class="bi bi-geo-alt-fill me-1"></i>47 Mabini St., San Juan City, Metro Manila, Philippines</p>
      </div>
      ...
      <div class="position-relative d-flex justify-content-center align-items-center mt-0 mb-3">
        ...
        <div class="image-frame">
          <!-- Main Image -->
        <img id="mainImage" src="assets/building/bldg9.jpg" style="width: 400px; height:350px; object-fit: cover; cursor:pointer;" onclick="openModal(this.src)" />
        </div>
      ...
      <div class="d-flex justify-content-center gap-2 flex-wrap mb-3 mt-3" id="thumbnails">
        <img src="assets/building/bldg9.jpg" class="thumbnail-img active" onclick="changeImage(this)" />
        <img src="assets/Unit/unit9.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit9a.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit9b.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Unit/unit9c.webp" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesm.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Amenities/amenitiesn.jpg" class="thumbnail-img" onclick="changeImage(this)" />
        <img src="assets/Location/location9.png" class="thumbnail-img" onclick="changeImage(this)" />
      </div>
    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content gradient-bg text-light">
      <div class="modal-header border-0">
        <h5 class="modal-title">UrbanVista Central – San Juan</h5>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7 pt-0">
              <p class="text-justify">
                Located in the heart of San Juan City, <strong>UrbanVista Central</strong> at 47 Mabini St. offers 
                a modern urban lifestyle, combining both residential and business-oriented amenities. Enjoy the 
                proximity to commercial centers, while having the comfort of a cozy living space equipped with premium features.
              </p>
              <hr class="my-4" />
              <!-- Amenities -->
              <h6 class="fw-semibold mb-3">Amenities</h6>
              <div class="row gy-2">
                <div class="col-6"><i class="bi bi-briefcase me-2"></i>Business park with co-working spaces</div>
                <div class="col-6"><i class="bi bi-fire me-2"></i>Cozy in-house fireplace</div>
                <div class="col-6"><i class="bi bi-camera-video me-2"></i>24/7 CCTV security</div>
                <div class="col-6"><i class="bi bi-wifi me-2"></i>High-speed internet</div>
                <div class="col-6"><i class="bi bi-lock me-2"></i>Secure entry access</div>
                <div class="col-6"><i class="bi bi-tree me-2"></i>Landscaped gardens and open spaces</div>
              </div>
              <!-- Nearby Locations -->
              <h6 class="fw-semibold mt-4 mb-3">Nearby Landmarks</h6>
              <div class="row gy-2">
                 <div class="col-12"><i class="bi bi-shop me-2"></i>Greenhills Shopping Center – 5 mins</div>
                <div class="col-12"><i class="bi bi-hospital me-2"></i>Cardinal Santos Medical Center – 7 mins</div>
                <div class="col-12"><i class="bi bi-train-front me-2"></i>Gilmore LRT Station – 10 mins</div>
                <div class="col-12"><i class="bi bi-bag me-2"></i>SM Megamall – 15 mins</div>
                <div class="col-12"><i class="bi bi-building me-2"></i>San Juan City Hall – 5 mins</div>
              </div>
              <!-- Location -->
              <h6 class="fw-semibold mt-4 mb-2">Location</h6>
              <p class="text-justify mb-0">
                <strong>UrbanVista Central – San Juan</strong><br />
                47 Mabini St., San Juan City, Metro Manila, Philippines
              </p>
            </div>
            <!-- RIGHT: Image -->
              <div class="col-lg-5 text-center">
              <img id="modalImage" src="" class="img-fluid rounded shadow" alt="UrbanVista Central – San Juan" />
            </div>
          </div>
        </div>
    </div>
