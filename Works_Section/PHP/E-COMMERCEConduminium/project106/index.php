...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css"  "stylesheet"/>
      ...
      <div class="col-md-6" style="text-align: justify;">
        ...
        <div class="mt-4 mb-3">
          <select class="form-select" id="locationSelect">
            ...
            <div class="option">
            <option value="urbanvista1.php">UrbanVista Tower 1, 888 Aurora Blvd, Quezon City</option>
            <option value="urbanvista2.php">UrbanVista Residences, 21 Bayview St., Pasay City</option>
            <option value="urbanvista3.php">UrbanVista Heights, 5 Jupiter St., Makati City</option>
            <option value="urbanvista4.php">UrbanVista Green, Katipunan Ave., Loyola Heights, Quezon City</option>
            <option value="urbanvista5.php">UrbanVista Prime, 77 Pioneer St., Mandaluyong City</option>
            <option value="urbanvista6.php">UrbanVista Oasis, 12 Sucat Road, Parañaque City</option>
            <option value="urbanvista7.php">UrbanVista Skyline, 1342 EDSA cor. Shaw Blvd., Mandaluyong</option>
            <option value="urbanvista8.php">UrbanVista Parklane, 19 Commonwealth Ave., Quezon City</option>
            <option value="urbanvista9.php">UrbanVista Central, 47 Mabini St., San Juan City</option>
            <option value="urbanvista10.php">UrbanVista Ridge, 86 Ortigas Ave., Pasig City</option>
  ...
  <div class="container">
    <div class="row justify-content-center text-start text-md-start">
      ...
      <div class="col-12 col-md-6 col-lg-4 mb-4">
        ...
        <p>
          <a href="urbanvista1.php" class="footer-link">UrbanVista Tower 1</a><br>
          <a href="urbanvista2.php" class="footer-link">UrbanVista Residences</a><br> 
          <a href="urbanvista3.php" class="footer-link">UrbanVista Heights</a><br>
          <a href="urbanvista4.php" class="footer-link">UrbanVista Green</a><br>
          <a href="urbanvista5.php" class="footer-link">UrbanVista Prime</a><br>
          <a href="urbanvista6.php" class="footer-link">UrbanVista Oasis</a><br>
          <a href="urbanvista7.php" class="footer-link">UrbanVista Skyline</a><br>
          <a href="urbanvista8.php" class="footer-link">UrbanVista Parklane</a><br>
          <a href="urbanvista9.php" class="footer-link">UrbanVista Central</a><br>
          <a href="urbanvista10.php" class="footer-link">UrbanVista Ridge</a><br>
        </p>
      </div>
