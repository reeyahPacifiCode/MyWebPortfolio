...
if ($searchQuery) {
    $sql = "SELECT product_id, product_name, product_description, product_img, product_price, product_type 
            FROM products_tbl
            WHERE product_type = 'Acoustic' AND product_status = 'Available' AND (product_name LIKE ? OR product_description LIKE ?)";
    ...
    $sql = "SELECT product_id, product_name, product_description, product_img, product_price, product_type 
            FROM products_tbl
            WHERE product_type = 'Acoustic' AND product_status = 'Available'" . $sortOrder; // Append sort order to the default query
...
<head>
    ...
    * {
    ...
    <title>Acoustic Guitars | TWO56TH NOTES</title>
</head>
    ...
    <div class="container-fluid products-container p-5">
        <div class='row'>
            <div class='col text-center'>
                <h1 id='title2'>Acoustic Guitars</h1>
            </div>
        </div>
        <div class='row'>
                    ...
                    <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                            <div class='container-fluid'>
                                ...
                                <div class='row mt-3'>
                                    <div class='col-md-12'>
                                        <h2><strong><?php echo htmlspecialchars($productName); ?></strong></h2>
