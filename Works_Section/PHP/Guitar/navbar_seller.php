...
<div class="navbar-fixed-top text-center">
    <nav class="navbar navbar-expand-sm navbar-light bg-light fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">TWO56TH NOTES Seller</a>
            ...
            <div class="collapse navbar-collapse bg-light" id="collapsibleNavId">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0 d-flex justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="seller_dashboard.php" aria-current="page">Home <span
                                class="visually-hidden">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="seller_products.php">Products</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="seller_orders.php">Orders</a>
                    </li>
                    <?php if ($Seller_ID == 0): ?>
                    <li class="nav-item">
                        <a class="nav-link btn btn-light" href="admin_message.php">View Messages</a>
                    </li>
                    <?php endif; ?>
