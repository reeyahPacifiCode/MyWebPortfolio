...
<body>
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
            <a class="navbar-brand" href="about_us.php">TWO56TH NOTES</a> <!-- rename -->
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="acoustic.php">Acoustic Guitar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="electric.php">Electric Guitar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="bass.php">Bass Guitar</a>
                    </li>
    ...
    <!-- Only include one version of each library to avoid conflicts -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Close the navbar on clicking a link
