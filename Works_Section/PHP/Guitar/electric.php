...
$sql = "SELECT product_id, product_name, product_description, product_img, product_price, product_type 
        FROM products_tbl
        WHERE product_type = 'Electric' AND product_status = 'Available'";
...
if ($searchQuery) {
    $sql = "SELECT product_id, product_name, product_description, product_img, product_price, product_type 
            FROM products_tbl
            WHERE product_type = 'Electric' AND product_status = 'Available' AND (product_name LIKE ? OR product_description LIKE ?)";
...
<head>
    ...
    * {
    ...
    <title>Electric Guitars | TWO56TH NOTES</title>
</head>
            ...
            <div class="container-fluid products-container p-5">
                <div class="row">
                    <div class="col text-center">
                        <h1 id="title2">Electric Guitars</h1>
                    </div>
                </div>
                <div class="row">
