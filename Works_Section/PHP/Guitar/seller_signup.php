...
if (isset($_POST['sign-up'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($result1->num_rows > 0) {
            ...
            $query2 = "SELECT * FROM `seller_tbl` WHERE `seller_email` = ?";
            ...
            if ($result2->num_rows > 0) {
                ...
                $query3 = "INSERT INTO `seller_tbl`(`seller_id`, `shop_name`, `seller_first_name`, `seller_last_name`, `seller_email`, `verification_code`, `seller_contact`, `seller_username`, `seller_password`) 
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                $stmt3 = $con->prepare($query3);
                $stmt3->bind_param("sssssssss", $customerID, $shopname, $firstname, $lastname, $email, $verificationCode, $contact, $username, $hashedPassword);
