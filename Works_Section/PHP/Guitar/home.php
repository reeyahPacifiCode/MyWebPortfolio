...
<head>
    ...
    * {
    ...
    <title>Home | TWO56TH NOTES</title>
</head>
...
<body>
    ...
    <div class="hero-section">
        <h1>Welcome to TWO56TH NOTES</h1>
        <p>Your one-stop shop for the latest in gyuitar instruments</p>
        <a href="acoustic.php" class="btn btn-primary">Shop Now</a>
    </div>
